      ...
      try {
        ...
        if (!res.success || !res.user) {
          ...
          if (msg.includes("unauthorized-domain")) {
            ...
            msg =
              "Sign-in popup was blocked. Your browser may be blocking popups. Try disabling your popup blocker or using an incognito window.";
          }
          setError(msg);
    ...
    >
      ...
      <div
        style={{
          ...
          pointerEvents: "none",
          background:
            "radial-gradient(ellipse at 30% 30%, rgba(99,102,241,0.12) 0%, transparent 60%), radial-gradient(ellipse at 70% 70%, rgba(139,92,246,0.08) 0%, transparent 60%)",
        }}
      />
